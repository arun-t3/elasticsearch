...
By default, Elasticsearch will be installed at `%PROGRAMFILES%\Elastic\Elasticsearch\6.2.0`. Navigate here and go into the bin directory as follows:

**with Command Prompt:**

[source,sh]
--------------------------------------------------
cd %PROGRAMFILES%\Elastic\Elasticsearch\6.2.0\bin
--------------------------------------------------
...
[source,powershell]
--------------------------------------------------
cd $env:PROGRAMFILES\Elastic\Elasticsearch\6.2.0\bin
--------------------------------------------------
